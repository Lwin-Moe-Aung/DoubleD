                                                ...
                                                <form action="{{ route('stocks.store') }}" method="POST" id="stockForm">
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            @if (!Carbon\Carbon::now()->between(Carbon\Carbon::createFromTimeString('15:02'), Carbon\Carbon::createFromTimeString('15:03')) && !Carbon\Carbon::now()->between(Carbon\Carbon::createFromTimeString('15:04'), Carbon\Carbon::createFromTimeString('15:05')))
