                                                ...
                                                <form action="{{ route('stocks.store') }}" method="POST" id="stockForm">
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            @if (!Carbon\Carbon::now()->between(Carbon\Carbon::createFromTimeString('23:55'), Carbon\Carbon::createFromTimeString('23:56')) && !Carbon\Carbon::now()->between(Carbon\Carbon::createFromTimeString('23:57'), Carbon\Carbon::createFromTimeString('23:58')))
