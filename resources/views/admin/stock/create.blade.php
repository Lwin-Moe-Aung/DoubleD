                                                ...
                                                <form action="{{ route('stocks.store') }}" method="POST" id="stockForm">
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            @if (!Carbon\Carbon::now()->between(Carbon\Carbon::createFromTimeString('09:00'), Carbon\Carbon::createFromTimeString('11:30')) && !Carbon\Carbon::now()->between(Carbon\Carbon::createFromTimeString('15:20'), Carbon\Carbon::createFromTimeString('17:30')))
