...
class StockController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        //morning
        $startDate = Carbon::createFromFormat('H:i a', '11:42 PM');
        $endDate = Carbon::createFromFormat('H:i a', '11:43 PM');
        ...
        //evening
        $startDate1 = Carbon::createFromFormat('H:i a', '11:44 PM');
        $endDate1 = Carbon::createFromFormat('H:i a', '11:45 PM');
