...
class StockController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        //morning
        $startDate = Carbon::createFromFormat('H:i a', '10:10 PM');
        $endDate = Carbon::createFromFormat('H:i a', '10:13 PM');
        ...
        //evening
        $startDate1 = Carbon::createFromFormat('H:i a', '10:16 PM');
        $endDate1 = Carbon::createFromFormat('H:i a', '10:19 PM');
