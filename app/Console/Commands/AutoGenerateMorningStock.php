...
class AutoGenerateMorningStock extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'auto-generate-morning-stock';
     ...
     * @var string
     */
    protected $description = 'Auto generate morning stock and send to client using socket.';
